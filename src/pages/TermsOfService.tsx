  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
      ...
      <main className="container mx-auto max-w-3xl px-6 py-16 sm:px-8 sm:py-20">
        ...
        <h1 className="text-4xl sm:text-5xl mt-2">Terms of Service</h1>
        ...
        <div className="prose prose-slate mt-10 max-w-none text-base leading-relaxed">
          ...
          <h2 className="text-2xl mt-10 mb-3">1. Eligibility</h2>
          <p>You must be at least 18 years old, a U.S. resident, and able to enter into a binding contract.</p>

          <h2 className="text-2xl mt-10 mb-3">2. Services</h2>
          <p>
          ...
          <h2 className="text-2xl mt-10 mb-3">3. Your Right to Cancel (CROA)</h2>
          <p>
          ...
          <h2 className="text-2xl mt-10 mb-3">4. Fees & Billing</h2>
          <ul className="list-disc pl-5 space-y-1.5">
            <li><strong>Monthly Plan:</strong> Three (3) monthly payments of $400.00 USD billed on the same day each month for three consecutive months. The subscription cancels automatically at the end of month three.</li>
            <li><strong>Upfront Plan:</strong> A single payment of $1,000.00 USD covering the full three-month engagement.</li>
          ...
          <h2 className="text-2xl mt-10 mb-3">5. No Guarantees of Results</h2>
          <p>
          ...
          <h2 className="text-2xl mt-10 mb-3">6. Your Responsibilities</h2>
          <ul className="list-disc pl-5 space-y-1.5">
          ...
          <h2 className="text-2xl mt-10 mb-3">7. Consumer Credit File Rights</h2>
          ...
          <h2 className="text-2xl mt-10 mb-3">8. Termination</h2>
          <p>
          ...
          <h2 className="text-2xl mt-10 mb-3">9. Disclaimers & Limitation of Liability</h2>
          <p>
            ...
            not exceed the fees you paid us during the three (3) months preceding the event giving rise
            to the claim. Nothing in these Terms limits any liability that cannot be limited under
            applicable law (including under CROA).
          </p>

          <h2 className="text-2xl mt-10 mb-3">10. Governing Law & Disputes</h2>
          <p>
          ...
          <h2 className="text-2xl mt-10 mb-3">11. Changes</h2>
          <p>
          ...
          <h2 className="text-2xl mt-10 mb-3">12. Contact</h2>
          <p>
            <a href="mailto:support@creditremovers.com" className="text-emerald-700 hover:underline">support@creditremovers.com</a>
          </p>
        </div>
